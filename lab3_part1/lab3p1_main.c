...
int main(void)
{
  ...
  msp_printf("PROBLEM 1: Setting PIE bit\r\n", 0);
    ...
    test_reg16 = set_bit(reg_value, PIE_BIT_MASK);
  ...
  test_reg16 = set_bit(test_reg16, (A1_BIT_MASK + A0_BIT_MASK + A2_BIT_MASK + A3_BIT_MASK));
  ...
  if(check_bit(test_reg16, A2_BIT_MASK))
    {
        msp_printf("Problem 5: A2 is 1\r\n", 0);
    }
    else 
    {
        msp_printf("Problem 5: A2 is 0\r\n",0);
    }
  ...
  test_reg16 = clear_bit(test_reg16, CRS_BIT_MASK);
  test_reg16 = set_bit(test_reg16, PRS_BIT_MASK);
  ...
  if(check_bit(test_reg16, A2_BIT_MASK))
    {
        msp_printf("Problem 8: A2 is 1\r\n", 0);
        test_reg16 = clear_bit(test_reg16, A2_BIT_MASK);
    }
    else 
    {
        msp_printf("Problem 8: A2 is 0\r\n", 0);
  ...
  if(check_bit(test_reg16, MD_BIT_MASK))
    {
        msp_printf("Problem 9: MD is 1\r\n", 0);
        test_reg16 = set_bit(test_reg16, MODE_BIT_MASK);
    }
    else 
    {
        msp_printf("Problem 9: MD is 0\r\n", 0);

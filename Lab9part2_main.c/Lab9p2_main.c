...
// This functions gets the temperature of the room using the adc 
// and that determins the speed of the dc motor.
// When pb1 is pressed the function ends.   
void run_lab9_part2()
{
    ...
    {
        adc = ADC0_in(5);
        temp = (thermistor_calc_temperature(adc) * (9.0/5)) +32; // converts the adc to Fahrenheit.
